...
class Octokit::RateLimit < Anonymous_Struct_28
...
module Octokit::Client::Reviews
  def create_pull_request_review(repo, id, options = nil); end
  ...
  def pull_request_review_requests(repo, id, options = nil); end
  def pull_request_reviews(repo, id, options = nil); end
  def request_pull_request_review(repo, id, reviewers, options = nil); end
