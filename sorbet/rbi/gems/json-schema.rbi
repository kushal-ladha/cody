...
class JSON::Schema::MinLengthAttribute < JSON::Schema::LimitAttribute
  def self.acceptable_type; end
  def self.error_message(schema); end
  def self.limit_name; end
  def self.value(data); end
end
class JSON::Schema::MaxLengthAttribute < JSON::Schema::MinLengthAttribute
  def self.error_message(schema); end
  def self.limit_name; end
end
class JSON::Schema::MinItemsAttribute < JSON::Schema::LimitAttribute
  def self.acceptable_type; end
  def self.error_message(schema); end
  def self.limit_name; end
  def self.value(data); end
end
class JSON::Schema::MaxItemsAttribute < JSON::Schema::MinItemsAttribute
  def self.error_message(schema); end
  def self.limit_name; end
end
class JSON::Schema::MinPropertiesAttribute < JSON::Schema::LimitAttribute
  def self.acceptable_type; end
  def self.error_message(schema); end
  def self.limit_name; end
  def self.value(data); end
end
class JSON::Schema::MaxPropertiesAttribute < JSON::Schema::MinPropertiesAttribute
  def self.error_message(schema); end
  def self.limit_name; end
end
