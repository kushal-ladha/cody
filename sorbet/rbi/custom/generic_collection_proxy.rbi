# See: https://github.com/Shopify/tapioca/issues/179#issuecomment-738948320
# This RBI file redfines `ActiveRecord::Associations::CollectionProxy` to be
# generic over the type of the model. This is to support generating `sig`s for
# associations that return the type of the model.
