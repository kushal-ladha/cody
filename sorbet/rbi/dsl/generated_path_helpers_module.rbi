...
module GeneratedPathHelpersModule
  ...
  def assigned_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def config_schema_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def config_validate_path(*args); end
  ...
  sig { params(args: T.untyped).returns(String) }
  def slack_command_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def slack_connect_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def update_rails_disk_service_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def webhooks_integration_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def webhooks_issue_comment_path(*args); end

  sig { params(args: T.untyped).returns(String) }
  def webhooks_pull_request_path(*args); end
end