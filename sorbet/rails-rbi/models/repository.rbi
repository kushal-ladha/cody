...
# Please rerun rake rails_rbi:models[Repository] to regenerate.
...
module Repository::GeneratedAssociationMethods
  ...
  sig { params(value: ::Installation).void }
  def installation=(value); end

  sig { returns(::PullRequest::ActiveRecord_Associations_CollectionProxy) }
  def pull_requests; end

  sig { params(value: T.any(T::Array[::PullRequest], ::PullRequest::ActiveRecord_Associations_CollectionProxy)).void }
  def pull_requests=(value); end

  sig { returns(::ReviewRule::ActiveRecord_Associations_CollectionProxy) }
  def review_rules; end

  sig { params(value: T.any(T::Array[::ReviewRule], ::ReviewRule::ActiveRecord_Associations_CollectionProxy)).void }
...
class Repository::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  sig { implementation.params(block: T.proc.params(e: Repository).void).void }
  def each(&block); end

  sig { params(level: T.nilable(Integer)).returns(T::Array[Repository]) }
...
class Repository::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(block: T.nilable(T.proc.void)).returns(Repository::ActiveRecord_AssociationRelation) }
  def unscoped(&block); end
