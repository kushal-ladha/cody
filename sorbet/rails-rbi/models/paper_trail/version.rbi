...
# Please rerun rake rails_rbi:models[PaperTrail::Version] to regenerate.
...
class PaperTrail::Version::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  sig { implementation.params(block: T.proc.params(e: PaperTrail::Version).void).void }
  def each(&block); end

  sig { params(level: T.nilable(Integer)).returns(T::Array[PaperTrail::Version]) }
...
class PaperTrail::Version::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(block: T.nilable(T.proc.void)).returns(PaperTrail::Version::ActiveRecord_AssociationRelation) }
  def unscoped(&block); end
