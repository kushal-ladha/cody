...
# Please rerun rake rails_rbi:models[ApiKey] to regenerate.
...
class ApiKey::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  sig { implementation.params(block: T.proc.params(e: ApiKey).void).void }
  def each(&block); end

  sig { params(level: T.nilable(Integer)).returns(T::Array[ApiKey]) }
...
class ApiKey::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(block: T.nilable(T.proc.void)).returns(ApiKey::ActiveRecord_AssociationRelation) }
  def unscoped(&block); end
